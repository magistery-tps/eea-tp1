...
```{r fig.height=4, fig.width=4, warning=FALSE, fig.align='center'}
segmented_box_plot(
  train_set, 
  column        = 'peso', 
...
```{r fig.height=5, fig.width=3, warning=FALSE, fig.align='center'}
...
```{r fig.height=3, fig.width=5, warning=FALSE, fig.align='center'}
...
```{r fig.height=4, fig.width=3, warning=FALSE, fig.align='center'}
box_plots(
