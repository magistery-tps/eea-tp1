...
En base a los resultados de importancia de variables realizados en la notebook de analisis exploratorio, $R^2$ ajustado
de los resultados y la significación de los coeficientes se seleccionaron las siguoentes variables:
...
Finalmente, si comparamos los modelos por $R^2$ Ajustado, se puede apreciar que el **Modelo 4** llega a captar la 
...
Como conclusión, no parece claro que el **Modelo Robusto** o el **Modelo 5** mejor que el **Modelo 1** en otro 
